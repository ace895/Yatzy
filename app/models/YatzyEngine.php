...
class YatzyEngine {
    ...
    function __construct() {
        ...
        $this->scores = $upperScores.concat($lowerScores);
        $this->loadHTML();
    }
    ...
    protected function loadHtmlDom(string $filePath): \DOMDocument {
